...
const newTicket = ref({
     title: "",
     content: `<h2>Hi Dear User,</h2><p>add your ticket content here ...</p>`,
     category_id: "",
});
...
function addNewTicket() {
     ...
     if((isTheContentEmpty || isTheContentTheSame) && newTicket.value.category_id == "" && newTicket.value.title == ""){
          toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Please fill all fields</div>`, {
               position: "top",
               duration: 5000,
               type: "error",
     ...
     if (newTicket.value.title == "" && newTicket.value.category_id == "") {
          toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Title and Category are required</div>`, {
               position: "top",
               duration: 5000,
               type: "error",
          ...
          toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Title is required</div>`, {
               position: "top",
               duration: 5000,
               type: "error",
          ...
          toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Category is required</div>`, {
               position: "top",
               duration: 5000,
               type: "error",
          ...
          toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Content is required</div>`, {
               position: "top",
               duration: 5000,
               type: "error",
          ...
          toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Content must be at least 50 characters</div>`, {
               position: "top",
               duration: 5000,
               type: "error",
     ...
     TicketService.createTicket(newTicket.value)
        ...
        toaster.show(`<div><i class="fa-solid fa-triangle-exclamation"></i> Ticket saved Successfuly</div>`, {
              position: "top",
              duration: 5000,
              type: "success",
...
<template>
  <!-- Hero -->
  <BasePageHeading title="add New ticket" subtitle="Pleas fill the form belong then send.">
    <template #extra>
  ...
  <div class="content">
    ...
    <BaseBlock title="add New Ticket    " content-full>
                                   <div class="d-flex justify-content-around">
                                                  <div
                                                       class="form-floating mb-4 col-7 animated bounceInLeft"
                                                  >
                                                       <input
                                                            type="text"
                                                  ...
                                                  >
                                                       ...
                                                       <label for="example-select-floating"
                                                            >Category</label
                                                       >
                                                  </div>
                                             </div>
